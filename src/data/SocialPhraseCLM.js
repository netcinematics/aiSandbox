export default function SocialPhraseCLM(){ //CUSTOM-LANGUAGE-MODEL
    return [
        'fill in the blank','raise all boats', 'good to go', 'early bird gets the worm', 'get it while its hot',
        'get the notion','rise to the occasion','bottom of the ocean','act of desperation','warm congratulations','just a simulation',
        ...
        'blown out of porportion','up to no good',
    ]}